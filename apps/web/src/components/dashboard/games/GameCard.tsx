  ...
  return (
    <div className="group relative aspect-[3/4] rounded-xl overflow-hidden border border-outline-variant/10 shadow-lg cursor-pointer">
      ...
      <div className="absolute inset-0 flex flex-col justify-end p-4">
        ...
        <button
          type="button"
          className="mt-3 bg-primary text-on-primary font-label-md py-2 rounded-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 cursor-pointer"
        >
          Juega Ahora
        </button>
      </div>

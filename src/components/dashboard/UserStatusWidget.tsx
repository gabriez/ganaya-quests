	...
	return (
		<section className="glass-card rounded-xl p-6 flex flex-col justify-between">
			...
			<div className="mt-6 pt-6 border-t border-outline-variant/10 flex justify-between items-center">
				<button className="bg-primary-container text-on-primary-container px-4 py-2 rounded-lg font-label-md hover:opacity-90 active:scale-95 transition-all cursor-pointer">
					Historial
				</button>
			</div>
		</section>
